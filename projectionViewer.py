...
class ProjectionViewer:
    ...
    def __init__(self, width, height):
        ...
        pygame.display.set_caption('F1 Bolid Simulation')
    ...
    def run(self):
        ...
        while running:
            ...
            #checking if bolid hit the ground, changing springs' state and moving bolid
            self.wireframes['bolid'].checkGround()
            self.wireframes['bolid'].checkSprings()
            self.wireframes['bolid'].move()
            self.display()
            pygame.display.flip()
